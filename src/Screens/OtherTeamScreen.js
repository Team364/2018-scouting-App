...
import { AppRegistry, Platform, StyleSheet, Text, View, Button, Navigator, TouchableHighlight, AsyncStorage, ViewList, ActivityIndicator,ListView, FlatList, TouchableOpacity, Image, TextInput} from 'react-native';
import SearchableFlatlist from "searchable-flatlist";

export default class OtherTeamScreen extends Component {
  LearnMore1 (){
...
static navigationOptions = ({ navigation }) => ({
   title: `Team: #${navigation.state.params.team_num}`,
...
componentDidMount() {
      ...
      return fetch(`http://www.quotin.co/React/admin-list-team.php?team_num=${ this.props.navigation.state.params.team_num }` , {
       method: 'POST',
       headers: {
