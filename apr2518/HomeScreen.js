...
class HomeScreen extends Component {
  ...
  render(){
      {/*This was changed from LoginScreen to QuestionScreen for testing because the json files are currently under maintience*/}
    return (
      ...
      <Image
        source={{uri: 'http://www.fusion364.com/img/fusion-scouting-app-logo.jpg'}}
